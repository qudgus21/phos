  ...
  return (
    <SectionWrapper>
      ...
      >
        ...
        <Link
          href="/upscale"
          className="inline-flex items-center px-12 py-4 text-lg font-extrabold text-white bg-gradient-to-r from-violet-600 via-violet-500 to-blue-500 rounded-2xl btn-glow transition-all hover:scale-105"
        >
          지금 체험하기
        </Link>
      </motion.div>
